      ...
      <div class="row">
        ...
        <vue-form :state="formstate" @submit.prevent="onSubmit" enctype="multipart/form-data">
          <div class="tester-profile-page">
                  ...
                  <div class="detail-form">
                    <div class="row">
                      <div class="col-lg-6 col-12">
                        ...
                        <input type="text" v-model="model.mobile_no" class="form-control d-inline-block" placeholder="Please enter your mobile number if you wish to be notified of new projects by text.">
                      </div>
                    </div>
                  </div>
              </div>
              <div class="white-box pb-3">
                ...
                <div class="row">
                  <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-2" v-for="(device, index) in aDevices">
                    ...
                    <toggle-button color="#2cac3d" :sync="true" :name="device.id" v-model="device_map[device.id]" @change="toggleChange(device.id)" />
                  </div>
                ...
                <div v-if="!deviceEmpty && !additional_devices.length" v-model="this.deviceEmpty" class="pl-3"><span class="text-danger">You must select at least one device.</span></div>
              </div>
              <div class="white-box">
                <h4 class="block-title">
                  About Me
                ...
                <validate tag="div">
                  ...
                  <!-- <field-messages name="additional_information" show="$invalid && $submitted" class="text-danger">
                    <div slot="required">Other Information is required</div>
                  </field-messages> -->
              ...
              <button class="btn text-uppercase text-center green-btn">Save Profile</button>
          </div>
        </vue-form>
      </div>
    </div>
  ...
  mounted: function() {
    ...
    axios
      ...
      .then(response => {
        ...
        this.aCountries[0] = this.aCountries[230];

        console.log(this.aCountries[37]);
      })
      .catch(function(error) {});
  },
  methods: {
    ...
    onSubmit: function() {
      ...
      if (
        this.otherInfoLengthInvalid ||
        this.formstate.$invalid ||
        (!this.deviceEmpty && !this.additional_devices.length)
      ) {
        ...
        if (this.model.id) {
          ...
          const devices = [];
          // Object(this.device_map).forEach(id => {
    ...
    handleChange: function(index, text) {
      ...
      console.log(this.additional_devices);
    },
