<template>
  <div>
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-8 col-12 text-center">
          <h1 class="page-title">
            Members
          </h1>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-4 col-12 pull-right">
            <router-link :to="{ name: 'admin.add_member' }" class="btn purple-btn add-member-btn">Add New Member</router-link>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
