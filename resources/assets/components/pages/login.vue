            ...
            <div class="col-lg-4 offset-lg-4 col-sm-6 offset-sm-3 col-10 offset-1 p-0 login-content">
                <div class="login-top-part">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group custom-form-group">
                                <button type="submit" :disabled="processing" class="btn green-btn text-center text-uppercase">Sign in</button>
                            </div>
                        </div>
                            ...
                            <validate tag="label">
                                <div class="form-group custom-form-group mb-0">
                                    <div class="checkbox">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="remember" id="remember" v-model="model.remember" check-box>
                                        <span class="cr">
...
import { isAdmin, logout, isLoggedIn } from "src/services/auth";
