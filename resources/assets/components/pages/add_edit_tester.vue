    ...
    <div class="row">
      <div class="col-12">
        <h1 class="step-page-title">
            ...
            <span class="" v-else>Add</span> Tester
        </h1>
      </div>
    </div>
    <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 border-right">
                <div class="row pb-3">
                    ...
                    <div class="col-md-8">
                      <validate tag="div">
                        <input v-model="model.first_name" name="first_name" type="text" required autofocus placeholder="First name" class="form-control custom-form-control" />
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-md-8">
                      <validate tag="div">
                        <input v-model="model.last_name" name="last_name" type="text" required autofocus placeholder="Last name" class="form-control custom-form-control" />
                ...
                <div class="row pb-3">
                  ...
                  <div class="col-md-8">
                    <validate tag="div">
                      <input v-model="model.email" name="email" type="email" autocomplete="off" required placeholder="E-mail" class="form-control custom-form-control" />
                ...
                <div class="row pb-3">
                  ...
                  <div class="col-md-8">
                    <validate tag="div">
                      <input v-model="model.password" name="password" autocomplete="off" type="password" :required="!model.id" placeholder="Password" class="form-control custom-form-control" />
                ...
                <div class="row pb-3">
                  ...
                  <div class="col-md-8">
                    <validate tag="div">
                      <input v-model="model.confirm_password" autocomplete="off" name="confirm_password"  type="password" :required="!model.id" placeholder="Confirm password" class="form-control custom-form-control" :sameas="model.password" />
                ...
                <div class="row pb-3">
                  ...
                  <div class="col-md-8">
                    <validate tag="div">
                      <input v-model="model.mobile_no" name="mobile" type="mobile" placeholder="Phone number" class="form-control custom-form-control" pattern="[0-9]{10}" />
                      <field-messages name="mobile" show="$invalid && $submitted" class="text-danger">
                          <div slot="pattern">Phone number is not valid</div>
                      </field-messages>
                  </validate>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="row pb-3">
                  <div class="col-md-4 pr-md-0 mb-2 mb-sm-1"><span class="text-medium">Date of birth <span class="input-required">*</span> : </span></div>
                  <div class="col-md-8">
                    <validate tag="div">
                        <datepicker initial-view="year" input-class="form-control custom-form-control" :format="'dd MMM yyyy'" v-model="model.date_of_birth" name="dob" required></datepicker>
                ...
                <div class="row pb-3">
                  <div class="col-md-4 pr-md-0 mb-2 mb-sm-1"><span class="text-medium">Gender <span class="input-required">*</span> : </span></div>
                  <div class="col-md-8">
                    <validate tag="div">
                      <select id="gender" name="gender" size="1" class="form-control custom-form-control" v-model="model.gender" required checkbox>
                ...
                <div class="row pb-3">
                  <div class="col-md-4 pr-md-0 mb-2 mb-sm-1"><span class="text-medium">City : </span></div>
                  <div class="col-md-8">
                    <validate tag="div">
                      <input name="city" type="text" placeholder="City" class="form-control custom-form-control" v-model="model.city" />
                ...
                <div class="row pb-3">
                  ...
                  <div class="col-md-8">
                    <validate tag="div">
                        <select id="country_id" name="country_id" required size="1" class="form-control custom-form-control" v-model="model.country_id" checkbox>
          ...
          <div class="row">
            <div class="col-12 text-center">
              <!-- <button type="reset" class="btn btn-effect-ripple btn-secondary reset_btn1" @click="form_reset">
                    Reset</button> -->
              <router-link :to="{ name: 'admin.tester' }" class="grey-btn">Back to testers</router-link>
              <button type="submit" class="purple-btn mr-0">
              <span class=""  v-if="$route.params.id">Save Tester</span>
...
export default {
  ...
  data() {
    return {
      formstate: {},
      header: this.$route.params.id ? "Edit Tester" : "Add Tester",
      model: { ...cleanData },
      errors: null,
      old_file: "",
      originalUser: {},
    ...
    onSubmit: function() {
      if (this.formstate.$invalid) {
        ...
        if (this.model.id) {
          ...
          p = axios.post("/api/tester", requestData);
        }
        p
          .then(response => this.$router.push({ name: "admin.tester" }))
          .catch(error => {
  ...
  mounted: function() {
    if (this.$route.params.id) {
      axios
        ...
        .then(({ data: { data } }) => {
          this.model = data;
          this.model.date_of_birth = new Date(this.model.date_of_birth);
