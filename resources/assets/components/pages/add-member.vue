    ...
    <div class="container custom-container">
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="row">
              <div class="col-md-6 border-right">
                ...
                <div class="row pb-3">
                  ...
                  <div class="col-md-8">
                    <input name="mobile" type="mobile" placeholder="Phone number" class="form-control" pattern="[0-9]{10}" />
                  </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-md-8">
                      <input autocomplete="off" name="confirm_password"  type="password" placeholder="Confirm password" class="form-control" />
                    </div>
                </div>
                <div class="row pb-3">
                    <div class="col-md-4 pr-md-0 mb-2 mb-sm-1"><span class="text-medium">Roles <span class="input-required">*</span> : </span></div>
                    <div class="col-md-8">
                        <select id="country_id" name="country_id" required size="1" class="form-control">
                ...
                <div class="row pb-3" >
                  ...
                  <div class="col-md-8">
                      ...
                      <div class="radio form-check-inline">
                        <label>
                          <input type="radio" name="is_active" value="Deactive">
                          <span class="cr"><i class="cr-icon fa fa-circle"></i></span>
                          Deactive
                        </label>
                      </div>
          ...
          <div class="mb-4 roles-note">
            <h4 class="text-bold">
              *Roles
            </h4>
            <ul class="pl-4">
              <li class="mb-2">
                <span class="text-medium">Subadmin : </span>
                <span class=""> Subadmin will have all rights which admin has. Only Sub-admin can not delete admin but admin can delete sub-admin</span>
              </li>
              <li class="mb-2">
                <span class="text-medium">Manager : </span>
                <span>Create/Edit test project, Review publisher's project, Review submission  of the testers, mark as completed , pay tester (in wallet)</span>
              </li>
              <li class="mb-2">
                <span class="text-medium">Moderator : </span>
                <span>Moderate tester, review tester's submission, review publisher, can edit tester/publisher and its status.</span>
              </li>
              <li class="">
                <span class="text-medium">Accountant : </span>
                <span>Can see withdrawal request, send payment to tester (in paypal), get reports of transaction, invoice checking</span>
              </li>
            </ul>
          </div>
          <div class="row">
            <div class="col-12 text-center">
              <router-link :to="{ name: 'admin.members' }" class="grey-btn">Back to members</router-link>
              <!-- <button type="reset" class="btn btn-effect-ripple btn-secondary reset_btn1" @click="form_reset">
                  Reset
              </button> -->
              <a href="#" class="purple-btn mr-0">Submit</a>
            </div>
          </div>
          </vue-form>
        </div>
