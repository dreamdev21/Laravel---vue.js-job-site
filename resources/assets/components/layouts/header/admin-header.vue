<template>
    <header :class="[ 'header fixed-top', userClass ]" >
        <nav>
            ...
            <div class="navbar-right">
                ...
                <div>
                    ...
                    <b-dropdown class="notifications-menu bell_bg" right link>
                        ...
                        <notifications>
                            <div slot="thumb-icon">
                                 <img src="~img/calendar_32x32.png" class="img-fluid" />
                            </div>
                        </notifications>
                        <notifications>
                            <div slot="thumb-icon">
                                 <img src="~img/message_32x32.png" class="img-fluid" />
                            </div>
                        </notifications>
                        <notifications>
                            <div slot="thumb-icon">
                                 <img src="~img/payment_32x32.png" class="img-fluid" />
                            </div>
                        </notifications>
                        <notifications>
                            <div slot="thumb-icon">
                                 <img src="~img/profile_32x32.png" class="img-fluid" />
                            </div>
                        </notifications>
                        <notifications>
                            <div slot="thumb-icon">
                                 <img src="~img/project_32x32.png" class="img-fluid" />
                            </div>
                        </notifications>
                    </b-dropdown>
                    ...
                    <b-dropdown class="user user-menu bell_bg user_btn" right link>
                        ...
                        <b-dropdown-item exact class="dropdown_content">
                            <router-link tag="a" :to="{name: 'admin.settings'}" exact class="drpodowtext">
